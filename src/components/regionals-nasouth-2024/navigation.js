    ...
    return (
        <section className="regionals-navigation">
            <div className="regionals-navigation-wrapper">
                ...
                <Link to="/regionals-nasouth-2024/staff" activeStyle={{ color: "rgb(195, 53, 52)", fontWeight: "bolder" }}>Staff & Volunteers</Link>
                <Link to="/regionals-nasouth-2024/sponsors" activeStyle={{ color: "rgb(195, 53, 52)", fontWeight: "bolder" }}>Sponsors & Vendors</Link>
                <Link to="/regionals-nasouth-2024/hospitality" activeStyle={{ color: "rgb(195, 53, 52)", fontWeight: "bolder" }}>Hospitality</Link>
                <Link to="/regionals-nasouth-2024/texas" activeStyle={{ color: "rgb(195, 53, 52)", fontWeight: "bolder" }}>Roller Derby in Texas</Link>
            </div>
        </section>
    );
};
